...
namespace DebtManagerApp {
	...
	public ref class DebtsTheyOwe : public System::Windows::Forms::Form
	{
	public:
		DebtsTheyOwe(void)
		{
			InitializeComponent();
			Load_exist_debt();
			flowLayoutPanel_2->AutoScroll = true;
            this->WindowState = FormWindowState::Maximized;
		}
    private: System::Windows::Forms::Button^ add_debt_they;
    private: System::Windows::Forms::Button^ backButton_1;
    ...
    private: System::Windows::Forms::Label^ AllDebtsAmount1;
...
#pragma region Windows Form Designer generated code
		...
		{
            System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DebtsTheyOwe::typeid));
            this->add_debt_they = (gcnew System::Windows::Forms::Button());
            this->backButton_1 = (gcnew System::Windows::Forms::Button());
            this->flowLayoutPanel_2 = (gcnew System::Windows::Forms::FlowLayoutPanel());
            this->panel1 = (gcnew System::Windows::Forms::Panel());
            this->AllDebtsAmount1 = (gcnew System::Windows::Forms::Label());
            this->SuspendLayout();
            // 
            // add_debt_they
            // 
            this->add_debt_they->BackColor = System::Drawing::Color::SpringGreen;
            this->add_debt_they->FlatStyle = System::Windows::Forms::FlatStyle::Popup;
            this->add_debt_they->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
                static_cast<System::Byte>(0)));
            this->add_debt_they->Location = System::Drawing::Point(30, 127);
            this->add_debt_they->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
            this->add_debt_they->Name = L"add_debt_they";
            this->add_debt_they->Size = System::Drawing::Size(173, 65);
            this->add_debt_they->TabIndex = 0;
            this->add_debt_they->Text = L"Add debt";
            this->add_debt_they->UseVisualStyleBackColor = false;
            this->add_debt_they->Click += gcnew System::EventHandler(this, &DebtsTheyOwe::add_debt_they_Click);
            // 
            // backButton_1
            // 
            this->backButton_1->BackColor = System::Drawing::Color::SpringGreen;
            this->backButton_1->FlatStyle = System::Windows::Forms::FlatStyle::Popup;
            this->backButton_1->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
                static_cast<System::Byte>(0)));
            this->backButton_1->Location = System::Drawing::Point(30, 219);
            this->backButton_1->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
            this->backButton_1->Name = L"backButton_1";
            this->backButton_1->Size = System::Drawing::Size(173, 65);
            this->backButton_1->TabIndex = 2;
            this->backButton_1->Text = L"Back To Menu";
            this->backButton_1->UseVisualStyleBackColor = false;
            this->backButton_1->Click += gcnew System::EventHandler(this, &DebtsTheyOwe::backButton_1_Click);
            // 
            // flowLayoutPanel_2
            // 
            this->flowLayoutPanel_2->BackColor = System::Drawing::Color::Transparent;
            this->flowLayoutPanel_2->Location = System::Drawing::Point(345, 127);
            this->flowLayoutPanel_2->Name = L"flowLayoutPanel_2";
            this->flowLayoutPanel_2->Size = System::Drawing::Size(1397, 800);
            ...
            // AllDebtsAmount1
            // 
            this->AllDebtsAmount1->AutoSize = true;
            this->AllDebtsAmount1->BackColor = System::Drawing::Color::Transparent;
            this->AllDebtsAmount1->Font = (gcnew System::Drawing::Font(L"Mongolian Baiti", 18, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
                static_cast<System::Byte>(0)));
            this->AllDebtsAmount1->Location = System::Drawing::Point(26, 460);
            this->AllDebtsAmount1->Name = L"AllDebtsAmount1";
            this->AllDebtsAmount1->Size = System::Drawing::Size(92, 31);
            this->AllDebtsAmount1->TabIndex = 4;
            this->AllDebtsAmount1->Text = L"label1";
            this->AllDebtsAmount1->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
            // 
            // DebtsTheyOwe
            // 
            ...
            this->ClientSize = System::Drawing::Size(1924, 903);
            this->Controls->Add(this->AllDebtsAmount1);
            this->Controls->Add(this->panel1);
            this->Controls->Add(this->flowLayoutPanel_2);
            this->Controls->Add(this->backButton_1);
            this->Controls->Add(this->add_debt_they);
            this->Icon = (cli::safe_cast<System::Drawing::Icon^>(resources->GetObject(L"$this.Icon")));
            this->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
            this->Name = L"DebtsTheyOwe";
            this->Text = L"Debts They Owe";
            this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &DebtsTheyOwe::DebtsTheyOwe_FormClosing);
            this->Load += gcnew System::EventHandler(this, &DebtsTheyOwe::DebtsTheyOwe_Load);
...
#pragma endregion
    ...
    private: System::Void add_debt_they_Click(System::Object^ sender, System::EventArgs^ e) {
    ...
    private: System::Void DebtPanel(String^ debtName, String^ debtAmount, Panel^ exist_Panel) {
        ...
        save->Click += gcnew System::EventHandler(this, &DebtsTheyOwe::save_Click);
        ...
        del->Click += gcnew System::EventHandler(this, &DebtsTheyOwe::delete_Click);
        ...
        more->Click += gcnew System::EventHandler(this, &DebtsTheyOwe::more_Click);
        ...
        {
            flowLayoutPanel_2->Controls->Add(newPanel);
        }
    }
    private: void Load_exist_debt() {

        if (!System::IO::File::Exists("debts_they.csv"))
        {
            return;
        }
    ...
    private: System::Void save_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        try {
            ...
            System::IO::File::WriteAllLines("debts_they.csv", updatedLines->ToArray());
    ...
    private: System::Void delete_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        try
        {
            ...
            System::IO::File::WriteAllLines("debts_they.csv", update_Line->ToArray());

            array<String^>^ detailsLines = System::IO::File::ReadAllLines("details_they.csv");
            ...
            System::IO::File::WriteAllLines("details_they.csv", updatedDetailsLines->ToArray());

            flowLayoutPanel_2->Controls->Remove(mainPanel);
    ...
    private: void DebtDetails(String^ debtName) {
        ...
        try {
            array<String^>^ lines = System::IO::File::ReadAllLines("details_they.csv");
            for each (String ^ line in lines) {
                array<String^>^ parts = line->Split(',');
                if (parts->Length == 3 && parts[0] == debtName) {
                    String^ date = parts[1];
        ...
        addPayment->Click += gcnew System::EventHandler(this, &DebtsTheyOwe::addPayment_Click);
        ...
        deletePayment->Click += gcnew System::EventHandler(this, &DebtsTheyOwe::deletePayment_Click);
    ...
    private: System::Void addPayment_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        try {
            ...
            System::IO::File::WriteAllLines("debts_they.csv", lines);
    ...
    private: System::Void deletePayment_Click(System::Object^ sender, System::EventArgs^ e) {
        ...
        try {
            ...
            System::IO::File::WriteAllLines("details_they.csv", updatedLines->ToArray());

            lines = System::IO::File::ReadAllLines("debts_they.csv");
            for (int i = 0; i < lines->Length; i++)
            {
                array<String^>^ parts = lines[i]->Split(',');
                if (parts->Length == 2 && parts[0] == debtName) {
    ...
    private: System::Void backButton_1_Click(System::Object^ sender, System::EventArgs^ e) {
        this->Hide();
        ShowMainScreen();
    }
    private: System::Void DebtsTheyOwe_Load(System::Object^ sender, System::EventArgs^ e) {
        updateAllDebtsAmount();
    }
    private: System::Void DebtsTheyOwe_FormClosing(System::Object^ sender, System::Windows::Forms::FormClosingEventArgs^ e) {
        e->Cancel = true;
        this->Hide();
        ShowMainScreen();
    }
